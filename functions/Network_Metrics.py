...
#------------------------------------------------------------------------------------#  
    ...
    def betweenness_centrality(self):
        ...
        The main changes are the addition of a distance weighting mechanism and the treatment of dependency with a different formula than Brandes, 
        which takes into account the number of predecessors and introduces a custom normalization.
